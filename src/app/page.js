      ...
      <div className='map-wrapper'>
        ...
        <div className='google-map'>
          ...
          <div className='map-text'>
            ...
            <Link  className ="phone-ico" href="tel:+233 543645082 tel:+233 302511909 "  target="_blank"><IconContext.Provider value={{ color: 'red', size: '10px', marginTop:'10px' }}> <span className="fon-ico"><FaPhone /></span> </IconContext.Provider ><p>4style Clothing</p> </Link>
